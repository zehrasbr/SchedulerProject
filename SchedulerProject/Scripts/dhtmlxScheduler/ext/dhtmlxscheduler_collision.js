...
var a=e._get_section_property();return t[a]==i[a]&&t.id!=i.id?!0:!1},e.checkCollision=function(t){var a=[],r=e.config.collision_limit;if(t.rec_type)for(var n=e.getRecDates(t),s=0;s<n.length;s++)for(var d=e.getEvents(n[s].start_date,n[s].end_date),l=0;l<d.length;l++)(d[l].event_pid||d[l].id)!=t.id&&a.push(d[l]);else{a=e.getEvents(t.start_date,t.end_date);for(var o=0;o<a.length;o++){var h=a[o];if(h.id==t.id||h.event_length&&[h.event_pid,h.event_length].join("#")==t.id){a.splice(o,1);break}}}var _=e._get_section_view(),c=e._get_section_property(),u=!0;
if(_){for(var g=0,o=0;o<a.length;o++)a[o].id!=t.id&&this._check_sections_collision(a[o],t)&&g++;g>=r&&(u=!1)}else a.length>=r&&(u=!1);if(!u){var f=!e.callEvent("onEventCollision",[t,a]);return f||(t[c]=i||t[c]),f}return u}}()});